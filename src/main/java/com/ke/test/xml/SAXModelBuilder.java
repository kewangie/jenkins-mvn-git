...
public class SAXModelBuilder extends DefaultHandler {
	...
	public void startElement(String namespace, String localname, String qname, Attributes atts) throws SAXException {
		...
		try {
			...
			String fullClassName = "com.ke.test.xml.model." + className;
			element = Class.forName(fullClassName).newInstance();
		} catch (Exception e) {
	...
	private void setProperty(String name, Object target, Object value) throws SAXException, IllegalAccessException, NoSuchFieldException {
